...
function common_subs
    ...
    sed -i.bak -e 's/bufferOutliers//g' $argv
...
sed -i.bak -e '1 s/.*/BUFFER	FILTER	NUMSOURCES	SENSINGDISTANCE	RUN	EVENTS	FALSE_NEGATIVES	FALSE_POSITIVES	NEGATIVES	PACKETS_SENT	POSITIVES	TRUE_NEGATIVES	TRUE_POSITIVES/' $infile-BaseValues.txt
sed -i.bak -e 's/ /\t/g' $infile-BaseValues.txt
sed -i.bak -e 's/-/ /g' $infile-BaseValues.txt
gawk -i inplace 'BEGIN{FS="\t";OFS="\t";} {print $5,$1,$2,$3,$4,$6,$7,$8,$9,$10,$11,$12,$13}' $infile-BaseValues.txt
...
sed -e '/Ideal/ d' $infile-BaseValues.txt > $infile-BaseValues-filterOn.txt
sed -i -e '/Off\s*Off/ d' $infile-BaseValues-filterOn.txt
sed -i -e '/On\s*Off/ d' $infile-BaseValues-filterOn.txt
echo "Produced file: $infile-BaseValues-filterOn.txt"

gawk 'BEGIN{FS="\t";OFS="\t";} {print $1,$2,$3,$4,$5,$10}' $infile-BaseValues.txt > $infile-Packets.txt
...
sed -i.bak -e '1 s/.*/BUFFER	FILTER	NUMSOURCES	SENSINGDISTANCE	RUN	FAILED_NO_INT	FAILED_WITH_INT	FAILED_BELOW_SENS	FAILED_NON_RX	RECEIVED_DESPITE_INT	RECEIVED_NO_INT/' $infile-RX.txt
sed -i.bak -e 's/ /\t/g' $infile-RX.txt
sed -i.bak -e 's/-/ /g' $infile-RX.txt
gawk -i inplace 'BEGIN{FS="\t";OFS="\t";} {print $5,$1,$2,$3,$4,$6,$7,$8,$9,$10,$11}' $infile-RX.txt
...
sed -i.bak -e '1 s/.*/BUFFER	FILTER	NUMSOURCES	RUN	SENSDISTANCE30	SENSDISTANCE40	SENSDISTANCE50/' $infile-BO.txt
sed -i.bak -e 's/ /\t/g' $infile-BO.txt
sed -i.bak -e 's/-/ /g' $infile-BO.txt
gawk -i inplace 'BEGIN{FS="\t";OFS="\t";} {print $4,$1,$2,$3,$5,$6,$7}' $infile-BO.txt
...
sed -i.bak -e '1 s/.*/BUFFER	FILTER	NUMSOURCES	RUN	SENSDISTANCE30	SENSDISTANCE40	SENSDISTANCE50/' $infile-Determinants.txt
sed -i.bak -e 's/ /\t/g' $infile-Determinants.txt
sed -i.bak -e 's/-/ /g' $infile-Determinants.txt
gawk -i inplace 'BEGIN{FS="\t";OFS="\t";} {print $4,$1,$2,$3,$5,$6,$7}' $infile-Determinants.txt
echo "Produced file: $infile-Determinants.txt"

cat bufferplots.r | string replace -r '[0-9][0-9][0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9][0-9][0-9]' $infile > bufferplots.r.bak
mv bufferplots.r.bak bufferplots.r
Rscript bufferplots.r
