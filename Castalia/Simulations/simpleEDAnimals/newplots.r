...
runs <- read.table("180320-154044-BaseValues-filterOn.txt", sep="\t", header=TRUE)
...
runs.sent <- read.table("180320-154044-Packets.txt", sep="\t", header=TRUE)
...
runs.edr <- read.table("180320-154044-Determinants.txt", sep="\t", header=TRUE)
...
runs.fail <- read.table("180320-154044-RX.txt", sep="\t", header=TRUE)
