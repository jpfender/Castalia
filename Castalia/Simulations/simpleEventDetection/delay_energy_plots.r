...
runs.delay <- read.table("170406-113052-DELAY.txt", sep="\t", header=TRUE)
...
runs.energy <- read.table("170406-113052-ENERGY.txt", sep="\t", header=TRUE)
...
runs.lifetime <- read.table("170406-113052-LIFETIME.txt", sep="\t", header=TRUE)
